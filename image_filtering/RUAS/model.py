...
from RUAS.operations import *
from torch.autograd import Variable
from RUAS.genotypes import PRIMITIVES
from RUAS.genotypes import Genotype
import itertools
import numpy as np
import RUAS.genotypes
from collections import OrderedDict
...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.enhance_net = EnhanceNetwork(iteratioin=self.iem_nums, channel=self.enhance_channel,
                                          genotype=Genotype(normal=[('skip_connect', 0), ('resconv_1x1', 1), ('resdilconv_3x3', 2), ('conv_3x3', 3), ('conv_3x3', 4), ('skip_connect', 5), ('conv_3x3', 6)], normal_concat=None, reduce=None, reduce_concat=None))
        self.denoise_net = DenoiseNetwork(layers=self.nrm_nums, channel=self.denoise_channel, genotype=Genotype(normal=[('resconv_1x1', 0), ('resconv_1x1', 1), ('resdilconv_3x3', 2), ('skip_connect', 3), ('resconv_1x1', 4), ('resconv_1x1', 5), ('skip_connect', 6)], normal_concat=None, reduce=None, reduce_concat=None))
    ...
    def _init_weights(self):
        model_dict = torch.load('/content/drive/MyDrive/image_filtering/RUAS/model/denoise.pt')
